...
SET SUMMARY="Multithreading.Scheduler"
SET DESCRIPTION="The idea is to create a dedicated threads for a particular work. The WorkPool class does not use the standard .NET thread pool."

%FAKE% %NYX% appName=Elders.Multithreading.Scheduler appReleaseNotes=%RELEASE_NOTES% appSummary=%SUMMARY% appDescription=%DESCRIPTION% nugetPackageName=Multithreading.Scheduler nugetserver=%RELEASE_TARGETSOURCE% nugetkey=%RELEASE_NUGETKEY%
