...
%FAKE% %NYX% "target=%TARGET%" appName=Elders.Multithreading.Scheduler appSummary=%SUMMARY% appDescription=%DESCRIPTION% nugetPackageName=Multithreading.Scheduler